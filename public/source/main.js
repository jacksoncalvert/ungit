...
WindowTitle.prototype.update = function () {
  ...
  // Add badge for unstaged changes
  if (this.unstagedCount > 0) {
    title = '(' + this.unstagedCount + ') ' + title;
  }
...
windowTitle.update();
// Make windowTitle globally accessible for other components
if (typeof ungit !== 'undefined') {
  ungit.windowTitle = windowTitle;
}
